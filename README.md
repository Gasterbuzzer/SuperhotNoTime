...
A very small mod that sets the games speed to a normal appearing game speed (0.6x).
...
4. Move the downloaded **SuperhotNoTime.dll** (From [Downloads](https://github.com/Gasterbuzzer/SuperhotNoTime/releases))
